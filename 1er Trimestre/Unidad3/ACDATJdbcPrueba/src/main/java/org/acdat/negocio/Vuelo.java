...
public class Vuelo {
    ...
    public boolean equals(Object o) {
        ...
        if (getId() != vuelo.getId()) return false;
        if (Double.compare(getCosto(), vuelo.getCosto()) != 0) return false;
        if (!getOrigen().equals(vuelo.getOrigen())) return false;
        return getDestino().equals(vuelo.getDestino());
    }
    ...
    public int hashCode() {
        ...
        long temp;
        result = getId();
        result = 31 * result + getOrigen().hashCode();
        result = 31 * result + getDestino().hashCode();
        result = 31 * result + getFecha_salida().hashCode();
        result = 31 * result + getFecha_llegada().hashCode();
        temp = Double.doubleToLongBits(getCosto());
