package com.dam.acdat.thymeleaf.controladores;

import com.dam.acdat.thymeleaf.modelo.entidades.EntidadEmpleados;
import org.springframework.ui.Model;
import com.dam.acdat.thymeleaf.modelo.dao.IDepartamentosDAO;
import com.dam.acdat.thymeleaf.modelo.dao.IEmpleadosDAO;
...
public class ViewController {
    ...
    public String mostrarEmpleados(Model model, @RequestParam(name = "depno", required = false) Integer depno) {
        ...
        if (depno == null)//|| depno == 0)
            ...
            empleados = (List<EntidadEmpleados>) empleadosDAO.findById(depno);
